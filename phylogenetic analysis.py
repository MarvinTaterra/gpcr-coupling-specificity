...
ax2.set_title('MI Pathway Clustering\n(MD-based)', fontsize=12, fontweight='bold')
...
known_families = {
    'Opioid': ['OPRK', 'OPRM'],
    'Endothelin': ['EDNRA', 'EDNRB'],
    'Adenosine': ['AA1R', 'AA2AR', 'AA3R'],
    'Serotonin': ['5HT2A', '5HT2B', '5HT4R', '5HT7R'],
    'Neuromedin_U': ['NMUR1', 'NMUR2'],
    'FFA': ['FFAR1', 'FFAR2', 'FFAR4'],
    'MCH': ['MCHR1', 'MCHR2'],
    'Prostaglandin': ['PE2R2', 'PE2R3', 'PE2R4', 'PF2R'],
}
...
# A
fig = plt.figure(figsize=(3.25, 5.5))
...
cb.set_label('Density', fontsize=7)
...
ax1.set_xlabel('Phylogenetic Distance', fontsize=8, fontweight='bold')
ax1.set_ylabel('Pathway Distance', fontsize=8, fontweight='bold')
ax1.set_title('A', fontsize=10, fontweight='bold', loc='left', pad=10)
...
for i, (bar, ratio) in enumerate(zip(bars, family_df_sorted['Ratio'])):
    ...
    ax2.text(width + 0.02, bar.get_y() + bar.get_height()/2,
            f'{ratio:.2f}', va='center', ha='left', fontsize=6)
...
ax2.set_yticklabels(family_labels, fontsize=7)

ax2.set_xlabel('Within/Between Family Distance Ratio', fontsize=8, fontweight='bold')
ax2.set_title('B', fontsize=10, fontweight='bold', loc='left', pad=10)
...
ax2.legend(handles=[sig_patch, nonsig_patch], 
           ...
           fontsize=6, frameon=True, edgecolor='gray', fancybox=False,
           ncol=2)
